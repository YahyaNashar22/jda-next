...
const LowerNav = () => {
  return (
    <div className="flex h-[120px] w-full bg-transparent items-center px-10 gap-5 justify-between">
      <div>
        <Image src={nav_logo} alt="website logo" height={77} width={283} />
      </div>
      <ul className="flex items-center text-xs gap-5  xl:text-[16px] text-white font-volkhov font-normal xl:gap-14">
